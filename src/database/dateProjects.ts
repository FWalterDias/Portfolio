...
export const projects:ProjectsProps[] = [
    {
        id: 1,
        titulo: "Formulario",
        descricao: "Prática de criação de formulário a partir de um layout no figma utilizando as tenologias vanilas do front-end",
        detalhes: "Esse Projeto foi desenvolvido a partir de um Figma, para praticar a contrução do Layout de formulários. Ele foi desenvolvido durante uma fomração na RocketSeat que visava formar desenvolvedores do Zero a Júniors.",
        capa: formulario,
        previws: [formmularioPrev1],
        tecnologias: ["HTML", "CSS"],
        area: ["Desenvolvimento Web", "Web Design"],
        link: "https://fwalterdias.github.io/Formulario-Rocketseat/"
    },
    {
        id: 2,
        titulo: "Galaxias",
        descricao: "Prática de criação Landing-Page a partir de um layout no figma utilizando as tenologias vanilas do front-end a partir do conceito Mobile First",
        detalhes: "Esse Projeto foi desenvolvido a partir de um Figma, para praticar a contrução do Layouts Responsivos. Ele foi desenvolvido durante uma fomração na RocketSeat que visava formar desenvolvedores do Zero a Júniors.",
        capa: galaxias,
        previws: [galaxiasPrev1, galaxiasPrev2],
        tecnologias: ["HTML", "CSS"],
        area: ["Desenvolvimento Web", "Web Design", "Layouts Responsivos"],
    ...
    },
    {
        id: 5,
        titulo: "Agenda",
        descricao: "Este projeto foi criado utilizando as tecnologias vanilas do front-end. Se trata de um modelo de agenda, estático.",
    ...
    },
    {
        id: 6,
        titulo: "CubosFlix",
        descricao: "Este projeto foi criado utulizando as tecnologias vanilas do Front-End. Se trata de uma pagina onde o usuario pode pesquisar sobre filmes e obter informações sobre ele",
        capa: cubosFlix,
    ...
    },
    {
        id: 7,
        titulo: "Din Din",
        descricao: "Este projeto foi criado utilizando React.JS. Ele se trata de um modelo de controle de finanças pessoais, onde o usuario pode cadastrar, editar e exluir transações.",
        ...
        tecnologias: ["HTML", "CSS", "JavaScript", "API REST", "React.js", "Node.js", "Axios"],
        area: ["Desenvolvimento Web", "Web Design"],
